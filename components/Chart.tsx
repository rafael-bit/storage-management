	...
	return (
		<Card className="flex items-center rounded-[20px] bg-brand p-5 text-white md:flex-col xl:flex-row">
			...
			<CardHeader className="flex-1 items-start px-3 py-0 sm:px-5 lg:p-3 xl:pr-5">
				<CardTitle className="text-2xl font-bold md:text-center lg:text-left">Available Storage</CardTitle>
				<CardDescription className=" mt-2 w-full text-white/70 md:text-center lg:text-left text-white">
